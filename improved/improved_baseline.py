...
model = LSTMComplex(vocab_size, embedding_dim, hidden_size, num_layers).to(device)
...
for epoch in range(num_epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        early_stopping_counter = 0
        torch.save(model.state_dict(), '/home/somaiya-1/Desktop/Generative-DL-for-Drug-Discovery/models/improved_lstm_model.pth')
    else:
